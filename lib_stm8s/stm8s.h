...
#define EXTI_CR1_PDIS1          7  // port D iterrupt sensitivity
#define EXTI_CR1_PDIS0          6  // port D iterrupt sensitivity
#define EXTI_CR1_PCIS1          5  // port C iterrupt sensitivity
#define EXTI_CR1_PCIS0          4  // port C iterrupt sensitivity
#define EXTI_CR1_PBIS1          3  // port B iterrupt sensitivity
#define EXTI_CR1_PBIS0          2  // port B iterrupt sensitivity
#define EXTI_CR1_PAIS1          1  // port A iterrupt sensitivity
#define EXTI_CR1_PAIS0          0  // port A iterrupt sensitivity
#define EXTI_CR2                _SFR_(EXTI_BASE_ADDRESS + 0x01)
#define EXTI_CR2_TLIS           2  // top level interrupt sensitivity
#define EXTI_CR2_PEIS1          1  // port E iterrupt sensitivity
#define EXTI_CR2_PEIS0          0  // port E iterrupt sensitivity
...
#define TIM1_IER_COMIE          5  // Communication interrupt enable
...
#define TIM1_SR1_COMIF          5  // Communication Interrupt Flag
...
/* Interrupts */
#define TLI_ISR                 0  // top level interrupt
#define AWU_ISR                 1  // auto awake from halt
#define CLK_ISR                 2
#define EXTI0_ISR               3  // port A
#define EXTI1_ISR               4  // port B
#define EXTI2_ISR               5  // port C
#define EXTI3_ISR               6  // port D
#define EXTI4_ISR               7  // port E
